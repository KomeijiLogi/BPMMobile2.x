...
function initData(data, flag) {
    var item = data.FormDataSet.洁丽康公司_汇款申请_主表[0];
    if (flag) {
...
function nodeControllerExp(NodeName) {
    if (String(NodeName).match('开始') != null) {
        ...
        upload();
        tapEvent();
        $("#fhkyt,#fhkfs,#fje,#fskdwmc,#fkhhmc,#fkhhzh,#fbz").removeAttr('readonly');
    }
}
