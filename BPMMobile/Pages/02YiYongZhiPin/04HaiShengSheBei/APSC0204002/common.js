function prepMsg() {
    ...
    var xml = `<?xml version= "1.0" ?>
                  <Requests>
                      ...
                      <ProcessName>爱普公司退换货申请</ProcessName>
...
function tapEvent() {
  ...
  <div id="mx" class="mui-card">
                    ...
                    <div class="mui-row cutOffLine padding">
                        ...
                        <div class="mui-col-xs-4" style="display:flex;">
                            <label>核算业务费底价</label>
                            <input type="number" id="fywf" placeholder="请填写"/>
                        </div>
                        <div class="mui-col-xs-4" style="display:flex;">
                            <label>备注说明</label>
...
function initData(data, flag) {
    ...
    var item_c = data.FormDataSet.爱普公司_退货申请_子表;
    for (var i = 0; i < item_c.length; i++) {
        ...
        var li = `<div id="mx" class="mui-card">
                    ...
                    <div class="mui-row cutOffLine padding">
                        ...
                        <div class="mui-col-xs-4" style="display:flex;">
                            <label>核算业务费底价</label>
                            <input type="number" id="fywf" readonly value="${item_c[i].核算业务费底价}"/>
                        </div>
                        <div class="mui-col-xs-4" style="display:flex;">
                            <label>备注说明</label>
...
function nodeControllerExp(nodeName) {
    ...
    if (String(nodeName).match('开始') != null) {
        ...
        $("#flxfs,#fkhmc,#fkhlb,#fkhxz,#fsxq,#fpsyy").removeAttr('readonly');
...
class Mx {
    constructor(fcpbm, fcpmc, fggxh, fxsdj, fywf, fbz) {
        this.fcpbm = fcpbm;
        this.fcpmc = fcpmc;
        this.fggxh = fggxh;
        this.fxsdj = fxsdj;
...
function Save() {
    ...
    $("#mxlist").find("#mx").each(function () {
        ...
        var fywf = $(this).find("#fywf").val();
        var fbz = $(this).find("#fbz").val();

        var mx = new Mx(fcpbm, fcpmc, fggxh, fxsdj, fywf, fbz);
        mxlistArr.push(mx);
    });
    if (!flxfs) {
        mui.toast('请填写联系方式');
    ...
    mui.confirm('即将提交，是否确定？', '提交确认提醒', btnArry, function (e) {
      ...
      <爱普公司_退货申请_子表>
            ...
            <核算业务费底价>${mxlistArr[i].fywf}</核算业务费底价>
