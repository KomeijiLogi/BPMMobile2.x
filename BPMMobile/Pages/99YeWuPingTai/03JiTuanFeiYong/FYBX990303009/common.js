...
function initData(data, flag) {
    item = data.FormDataSet.fybx_qtfy_m[0];
    ...
    $("#fysqdcode").val(item.fysqdcode);
    $("#fysqd").val(item.fysqd);
    $("#sqje").val(item.sqje);
    ...
    item_c = data.FormDataSet.fybx_qtfy_t;
    for (var i = 0; i < item_c.length; i++) {
        var li = ` <div id="mx">
                        ...
                        <div class="mui-row cutOffLine padding">
                            ...
                            <div class="mui-col-xs-3" style="display:flex;">
                                <label>超申请情况</label>
                                <textarea rows="2" id="chaosqqk" readonly>${item_c[i].chaosqqk}</textarea>
                            </div>  
                        </div>
                        <div class="mui-row cutOffLine padding">
        ...
        consignAjax.then(function () {
            ...
            xml += `
                        <fybx_qtfy_m>
                            ...
                            <fysqdcode>${item.fysqdcode}</fysqdcode>
