function prepMsg() {
    ...
    var xml = `<?xml version= "1.0" ?>
                  <Requests>
                      ...
                      <ProcessName>食品餐饮公司物资采购申请</ProcessName>
...
function tapEvent() {
        ...
        var li = `<div id="mx" class="mui-card">
                     ...
                     <div class="mui-row cutOffLine" style="padding-left:.8rem;">
                         <div class="mui-col-xs-3" style="display:flex;">
                             ...
                             <input type="text" id="fpm" name="fpm" placeholder="请填写"/>
                         </div>
                         <div class="mui-col-xs-3" style="display:flex;">
                             <label>单位<i style="color:red;">*</i></label> 
                             <input type="text" id="fdw" name="fdw" placeholder="请填写"/>
                         </div>
                          <div class="mui-col-xs-3" style="display:flex;">
                             <label>规格<i style="color:red;">*</i></label> 
                             <input type="text" id="fgg" name="fgg" placeholder="请填写"/>
                         </div>  
                         <div class="mui-col-xs-3" style="display:flex;">
                             <label>数量<i style="color:red;">*</i></label>
                             <input type="number" id="fsl" name="fsl" placeholder="请填写"/>
                         </div>
                     </div> 
                     <div class="mui-row cutOffLine" style="padding-left:.8rem;">
                         <div class="mui-col-xs-4" style="display:flex;">
                              <label>申请单价<i style="color:red;">*</i></label>
                              <input type="number" id="fsqdj" name="fsqdj" placeholder="请填写"/>
                         </div> 
                         <div class="mui-col-xs-4" style="display:flex;">
                              <label>采购单价<i style="color:red;">*</i></label>
                              <input type="number" id="fcgdj" name="fcgdj" placeholder="请填写"/>
                         </div>
                         <div class="mui-col-xs-4" style="display:flex;">
                              <label>采购总价</label>
                              <input type="number" id="fcgzj" name="fcgzj" readonly/>
                         </div>
    ...
    showPicker('fwzlb', fwzlxdata);


}

function initData(data, flag) {
    var item = data.FormDataSet.BPM_LYCYCGSQ_A[0];
    if (flag) {
    ...
    $("#ftel").val(item.ftel);
    $("#fwzlb").val(item.fwzlx);
    $("#fczj_total").val(item.fcg_total);

    var item_c = data.FormDataSet.BPM_LYCYCGSQ_B;
    for (var i = 0; i < item_c.length; i++) {
        ...
        var li = `
                  <div id="mx" class="mui-card">
                     ...
                     <div class="mui-row cutOffLine" style="padding-left:.8rem;">
                         <div class="mui-col-xs-3 flexLine">
                             <label>品名<i style="color:red;">*</i></label> 
                     ...
                     <div class="mui-row cutOffLine" style="padding-left:.8rem;">
                         <div class="mui-col-xs-4 flexLine">
                              <label>申请单价<i style="color:red;">*</i></label>
                         ...
                         <div class="mui-col-xs-4 flexLine">
                              <label>采购总价</label>
                              <input type="number" id="fcgzj" name="fcgzj" readonly value="${item_c[i].fzgxj}"/>
                         </div>
                     </div>  
                     <div class="mui-row cutOffLine" style="padding-left:.8rem;">
                         <div class="mui-col-xs-6 flexLine">
                             <label>采购要求</label>
                             <textarea rows="2" id="fcgyq" name="fcgyq" readonly>${item_c[i].fcgyq}</textarea>
                         </div>  
                         <div class="mui-col-xs-6 flexLine">
                             <label>采购供应商<i style="color:red;">*</i></label>
                             <textarea rows="2" id="fcggys" name="fcggys" readonly>${item_c[i].fcggys}</textarea>
                         </div>  
                     </div>
                  </div>
                  `;
...
class MxItem {
    constructor(fpm, fdw, fgg, fsl, fsqdj, fcgdj, fcgzj, fcgyq, fcggys) {
        this.fpm = fpm;
        this.fdw = fdw;
        this.fgg = fgg;
        this.fsl = fsl;
...
function Save() {
    ...
    $("#mxlist").find("#mx").each(function () {
        ...
        var mx = new MxItem(fpm, fdw, fgg, fsl, fsqdj, fcgdj, fcgzj, fcgyq, fcggys);
        ...
        if (e.index == 1) {
            ...
            xml += `
                       <BPM_LYCYCGSQ_A>
                            ...
                            <ftel>${ftel}</ftel>
                            <fwzlx>${fwzlb}</fwzlx>
                            <fcg_total>${fczj_total}</fcg_total>
                            <fj>${fjArray.join(";")}</fj>
                        </BPM_LYCYCGSQ_A>
                   `;
            for (var i = 0; i < mxlistArr.length; i++) {
                xml += `
                          <BPM_LYCYCGSQ_B>
                            ...
                            <fzgxj>${mxlistArr[i].fcgzj}</fzgxj>
                            <fcgyq>${mxlistArr[i].fcgyq}</fcgyq>
                            <fcggys>${mxlistArr[i].fcggys}</fcggys>
                        </BPM_LYCYCGSQ_B>
                       `;
            }
            xml += ` </FormData>
